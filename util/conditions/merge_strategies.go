...
type mergeOptions struct {
	conditionTypes                     []addonv1.ConditionType
	addSourceRef                       bool
	addStepCounter                     bool
	addStepCounterIfOnlyConditionTypes []addonv1.ConditionType
	stepCounter                        int
}
...
func WithConditions(t ...addonv1.ConditionType) MergeOption {
...
// IMPORTANT: This options works only while generating the Summary condition.
func WithStepCounterIfOnly(t ...addonv1.ConditionType) MergeOption {
	return func(c *mergeOptions) {
...
func getFirstReason(g conditionGroups, order []addonv1.ConditionType, addSourceRef bool) string {
...
func getFirstMessage(groups conditionGroups, order []addonv1.ConditionType) string {
...
func getFirstCondition(g conditionGroups, priority []addonv1.ConditionType) *localizedCondition {
	topGroup := g.TopGroup()
	if topGroup == nil {
		return nil
	}
