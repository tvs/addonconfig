...
type Setter interface {
	Getter
	SetConditions(addonv1.Conditions)
}
...
func Set(to Setter, condition *addonv1.Condition) {
...
func TrueCondition(t addonv1.ConditionType) *addonv1.Condition {
	return &addonv1.Condition{
		Type:   t,
...
func FalseCondition(t addonv1.ConditionType, reason string, severity addonv1.ConditionSeverity, messageFormat string, messageArgs ...interface{}) *addonv1.Condition {
	return &addonv1.Condition{
		Type:     t,
...
func UnknownCondition(t addonv1.ConditionType, reason string, messageFormat string, messageArgs ...interface{}) *addonv1.Condition {
	return &addonv1.Condition{
		Type:    t,
...
func MarkTrue(to Setter, t addonv1.ConditionType) {
	Set(to, TrueCondition(t))
}

// MarkUnknown sets Status=Unknown for the condition with the given type.
func MarkUnknown(to Setter, t addonv1.ConditionType, reason, messageFormat string, messageArgs ...interface{}) {
...
func MarkFalse(to Setter, t addonv1.ConditionType, reason string, severity addonv1.ConditionSeverity, messageFormat string, messageArgs ...interface{}) {
...
func SetMirror(to Setter, targetCondition addonv1.ConditionType, from Getter, options ...MirrorOptions) {
...
func SetAggregate(to Setter, targetCondition addonv1.ConditionType, from []Getter, options ...MergeOption) {
	Set(to, aggregate(from, targetCondition, options...))
}

// Delete deletes the condition with the given type.
func Delete(to Setter, t addonv1.ConditionType) {
	if to == nil {
		return
	}

	conditions := to.GetConditions()
	newConditions := make(addonv1.Conditions, 0, len(conditions))
...
func lexicographicLess(i, j *addonv1.Condition) bool {
	return (i.Type == addonv1.ReadyCondition || i.Type < j.Type) && j.Type != addonv1.ReadyCondition
}
...
func hasSameState(i, j *addonv1.Condition) bool {
