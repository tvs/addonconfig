...
type PatchOperation struct {
	Before *addonv1.Condition
	After  *addonv1.Condition
...
type applyOptions struct {
	ownedConditions []addonv1.ConditionType
	forceOverwrite  bool
}

func (o *applyOptions) isOwnedCondition(t addonv1.ConditionType) bool {
...
func WithOwnedConditions(t ...addonv1.ConditionType) ApplyOption {
