...
func merge(conditions []localizedCondition, targetCondition addonv1.ConditionType, options *mergeOptions) *addonv1.Condition {
...
func (g conditionGroups) TrueGroup() *conditionGroup {
	return g.getByStatusAndSeverity(corev1.ConditionTrue, addonv1.ConditionSeverityNone)
}
...
func (g conditionGroups) ErrorGroup() *conditionGroup {
	return g.getByStatusAndSeverity(corev1.ConditionFalse, addonv1.ConditionSeverityError)
}
...
func (g conditionGroups) WarningGroup() *conditionGroup {
	return g.getByStatusAndSeverity(corev1.ConditionFalse, addonv1.ConditionSeverityWarning)
}

func (g conditionGroups) getByStatusAndSeverity(status corev1.ConditionStatus, severity addonv1.ConditionSeverity) *conditionGroup {
	if len(g) == 0 {
		return nil
	}
	for _, group := range g {
...
type conditionGroup struct {
	...
	severity   addonv1.ConditionSeverity
...
func (g conditionGroup) mergePriority() int {
	...
	case corev1.ConditionFalse:
		switch g.severity {
		case addonv1.ConditionSeverityError:
			return 0
		case addonv1.ConditionSeverityWarning:
			return 1
		case addonv1.ConditionSeverityInfo:
			return 2
		}
