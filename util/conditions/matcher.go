...
// MatchConditions returns a custom matcher to check equality of addonv1.Conditions.
func MatchConditions(expected addonv1.Conditions) types.GomegaMatcher {
...
// MatchCondition returns a custom matcher to check equality of addonv1.Condition.
func MatchCondition(expected addonv1.Condition) types.GomegaMatcher {
...
type matchCondition struct {
	expected addonv1.Condition
}

func (m matchCondition) Match(actual interface{}) (success bool, err error) {
	actualCondition, ok := actual.(addonv1.Condition)
	if !ok {
