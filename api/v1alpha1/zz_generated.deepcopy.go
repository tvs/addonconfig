...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LabelSelectorKeyVal) DeepCopyInto(out *LabelSelectorKeyVal) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LabelSelectorKeyVal.
func (in *LabelSelectorKeyVal) DeepCopy() *LabelSelectorKeyVal {
	if in == nil {
		return nil
	}
	out := new(LabelSelectorKeyVal)
	in.DeepCopyInto(out)
	return out
}
